...
const TemplatePage = () => {
  ...
  useEffect(() => {
    ...
    if (!scrapedData) {
      const sampleData = [
        { id: 1, title: 'Product 1', price: '$19.99', category: 'Electronics', rating: 4.5, inStock: true },
        { id: 2, title: 'Product 2', price: '$29.99', category: 'Clothing', rating: 3.8, inStock: true },
        { id: 3, title: 'Product 3', price: '$9.99', category: 'Books', rating: 4.2, inStock: false },
        { id: 4, title: 'Product 4', price: '$49.99', category: 'Electronics', rating: 4.7, inStock: true },
        { id: 5, title: 'Product 5', price: '$15.99', category: 'Home & Kitchen', rating: 4.0, inStock: true },
      ];
      ...
      <div className="container">
        ...
        <section className="content-section">
          <Card className="intro-card">
            ...
            <p>
              This page displays the data results from the scraper. The table below shows either actual scraped data
              or sample demonstration data if no scraping has been performed yet.
            </p>
          </Card>
        </section>
